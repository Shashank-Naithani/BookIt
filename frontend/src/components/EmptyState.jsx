const EmptyState = ({ icon, title, description, action }) => {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
      {/* Icon */}
      <div className="w-16 h-16 rounded-2xl bg-surface-muted flex items-center justify-center text-text-muted">
        {icon || (
          <svg
            className="w-8 h-8"
            fill="none"
      ...
      {/* Text */}
      <div>
        <p className="text-text-heading font-semibold text-lg">{title}</p>
        {description && (
